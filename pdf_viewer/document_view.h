...
class DocumentView {
  ...
  public:
    ...
    void absolute_to_window_pos(
        float absolute_x, float absolute_y, float* window_x, float* window_y
    );
    // void absolute_to_window_pos_pixels(float absolute_x, float absolute_y,
    ...
    fz_rect document_to_window_rect_pixel_perfect(
    ...
    void get_absolute_delta_from_doc_delta(
        float doc_dx, float doc_dy, float* abs_dx, float* abs_dy
    );
    ...
    void open_document(
        ...
        bool foce_load_dimensions = false
    );
    ...
    void get_page_chapter_index(
        int page, std::vector<TocNode*> toc_nodes, std::vector<int>& res
    );
