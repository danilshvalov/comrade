...
struct sqlite3_vfs {
    ...
    int (*xOpen
    )(sqlite3_vfs*, const char* zName, sqlite3_file*, int flags, int* pOutFlags
    );
...
*/
SQLITE_API void*
sqlite3_update_hook(sqlite3*, void (*)(void*, int, const char*, const char*, sqlite3_int64), void*);
...
SQLITE_API int sqlite3_status64(
    int op, sqlite3_int64* pCurrent, sqlite3_int64* pHighwater, int resetFlag
);
...
struct sqlite3_pcache_methods2 {
    ...
    void (*xRekey
    )(sqlite3_pcache*, sqlite3_pcache_page*, unsigned oldKey, unsigned newKey);
...
SQLITE_API int sqlite3rebaser_rebase(
    sqlite3_rebaser*, int nIn, const void* pIn, int* pnOut, void** ppOut
);
