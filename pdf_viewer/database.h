...
class DatabaseManager {
  ...
  public:
    ...
    bool select_links(
        const std::string& src_checksum, std::vector<Portal>& out_result
    );
    ...
    bool global_select_bookmark(
        std::vector<std::pair<std::string, BookMark>>& out_result
    );
    bool global_select_highlight(
    ...
    bool select_highlight(
        const std::string& checksum, std::vector<Highlight>& out_result
    );
    bool select_highlight_with_type(
        const std::string& checksum,
        char type,
        std::vector<Highlight>& out_result
    );
