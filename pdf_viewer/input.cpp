...
class TextCommand : public Command {
  ...
  public:
    virtual std::string text_requirement_name() { return "text"; }
...
class GotoMark : public SymbolCommand {
    ...
    std::string get_name() { return "goto_mark"; }
...
class SetMark : public SymbolCommand {
    ...
    std::string get_name() { return "set_mark"; }
...
class NextItemCommand : public Command {
    ...
    std::string get_name() { return "next_item"; }
};
...
class PrevItemCommand : public Command {
    ...
    std::string get_name() { return "previous_item"; }
};
...
class SearchCommand : public TextCommand {
    ...
    std::string get_name() { return "search"; }

    bool pushes_state() { return true; }

    std::string text_requirement_name() { return "Search Term"; }
};
...
class ChapterSearchCommand : public TextCommand {
    ...
    std::string get_name() { return "chapter_search"; }
...
class RegexSearchCommand : public TextCommand {
    ...
    std::string get_name() { return "regex_search"; }

    bool pushes_state() { return true; }

    std::string text_requirement_name() { return "regex"; }
};
...
class AddBookmarkCommand : public TextCommand {
    ...
    std::string get_name() { return "add_bookmark"; }

    std::string text_requirement_name() { return "Bookmark Text"; }
};

class GotoBookmarkCommand : public Command {
    void perform(MainWidget* widget) { widget->handle_goto_bookmark(); }

    bool pushes_state() { return true; }

    std::string get_name() { return "goto_bookmark"; }
};

class GotoBookmarkGlobalCommand : public Command {
    void perform(MainWidget* widget) { widget->handle_goto_bookmark_global(); }
...
class GotoHighlightCommand : public Command {
    ...
    void perform(MainWidget* widget) { widget->handle_goto_highlight(); }

    bool pushes_state() { return true; }

    std::string get_name() { return "goto_highlight"; }
};

class GotoHighlightGlobalCommand : public Command {
    void perform(MainWidget* widget) { widget->handle_goto_highlight_global(); }
...
class GotoTableOfContentsCommand : public Command {
    ...
    void perform(MainWidget* widget) { widget->handle_goto_toc(); }

    std::string get_name() { return "goto_toc"; }
};

class PortalCommand : public Command {

    void perform(MainWidget* widget) { widget->handle_portal(); }

    std::string get_name() { return "portal"; }
};
...
class AddHighlightCommand : public SymbolCommand {
    ...
    void perform(MainWidget* widget) { widget->handle_add_highlight(symbol); }

    std::string get_name() { return "add_highlight"; }
};
...
class OpenDocumentCommand : public Command {
    ...
    void set_file_requirement(std::wstring value) { file_name = value; }

    void perform(MainWidget* widget) { widget->open_document(file_name); }

    std::string get_name() { return "open_document"; }
...
class MoveDownCommand : public Command {
    ...
    std::string get_name() { return "move_down"; }
};
...
class MoveUpCommand : public Command {
    ...
    std::string get_name() { return "move_up"; }
};
...
class ZoomInCommand : public Command {
    ...
    std::string get_name() { return "zoom_in"; }
};
...
class FitToPageWidthCommand : public Command {
    ...
    std::string get_name() { return "fit_to_page_width"; }
};
...
class FitToPageWidthSmartCommand : public Command {
    ...
    std::string get_name() { return "fit_to_page_width_smart"; }
};
...
class FitToPageHeightCommand : public Command {
    ...
    std::string get_name() { return "fit_to_page_height"; }
};
...
class FitToPageHeightSmartCommand : public Command {
    ...
    std::string get_name() { return "fit_to_page_height_smart"; }
};
...
class PreviousPageCommand : public Command {
    ...
    std::string get_name() { return "previous_page"; }
};
...
class ZoomOutCommand : public Command {
    ...
    std::string get_name() { return "zoom_out"; }
};
...
class GotoDefinitionCommand : public Command {
    ...
    std::string get_name() { return "goto_definition"; }

    bool pushes_state() { return true; }
};

class OverviewDefinitionCommand : public Command {
    void perform(MainWidget* widget) { widget->overview_to_definition(); }

    std::string get_name() { return "overview_definition"; }
};

class PortalToDefinitionCommand : public Command {
    void perform(MainWidget* widget) { widget->portal_to_definition(); }

    std::string get_name() { return "portak_to_definition"; }
};
...
class MoveVisualMarkDownCommand : public Command {
    ...
    std::string get_name() { return "move_visual_mark_down"; }
};
...
class MoveVisualMarkUpCommand : public Command {
    ...
    std::string get_name() { return "move_visual_mark_up"; }
};
...
class GotoPageWithPageNumberCommand : public TextCommand {
    ...
    std::string get_name() { return "goto_page_with_page_number"; }

    std::string text_requirement_name() { return "Page Number"; }
...
class DeletePortalCommand : public Command {
    ...
    std::string get_name() { return "delete_portal"; }
};
...
class DeleteBookmarkCommand : public Command {
    ...
    std::string get_name() { return "delete_bookmark"; }
};
...
class DeleteHighlightCommand : public Command {
    ...
    std::string get_name() { return "delete_highlight"; }
};
...
class GotoPortalCommand : public Command {
    ...
    std::string get_name() { return "goto_link"; }
};
...
class EditPortalCommand : public Command {
    ...
    std::string get_name() { return "edit_portal"; }
};

class OpenPrevDocCommand : public Command {
    void perform(MainWidget* widget) { widget->handle_open_prev_doc(); }

    bool pushes_state() { return true; }

    std::string get_name() { return "open_prev_doc"; }
...
class OpenDocumentEmbeddedCommand : public Command {
    ...
    std::string get_name() { return "open_document_embedded"; }
...
class CopyCommand : public Command {
    ...
    std::string get_name() { return "copy"; }
};
...
class GotoBeginningCommand : public Command {
  public:
    ...
    std::string get_name() { return "goto_beginning"; }
};
...
class GotoEndCommand : public Command {
  public:
    ...
    std::string get_name() { return "goto_end"; }
};
...
class ExternalSearchCommand : public SymbolCommand {
    ...
    std::string get_name() { return "external_search"; }
};
...
class ScreenDownCommand : public Command {
    ...
    std::string get_name() { return "screen_down"; }
};
...
class ScreenUpCommand : public Command {
    ...
    std::string get_name() { return "screen_up"; }
};
...
class NextChapterCommand : public Command {
    ...
    std::string get_name() { return "next_chapter"; }
};
...
class PrevChapterCommand : public Command {
    ...
    std::string get_name() { return "prev_chapter"; }
};
...
class ToggleDarkModeCommand : public Command {
    ...
    std::string get_name() { return "toggle_dark_mode"; }
...
class ToggleCustomColorMode : public Command {
    ...
    std::string get_name() { return "toggle_custom_color"; }
...
class TogglePresentationModeCommand : public Command {
    ...
    void perform(MainWidget* widget) { widget->toggle_presentation_mode(); }

    std::string get_name() { return "toggle_presentation_mode"; }
...
class TurnOnPresentationModeCommand : public Command {
    ...
    void perform(MainWidget* widget) { widget->set_presentation_mode(true); }

    std::string get_name() { return "turn_on_presentation_mode"; }
...
class ToggleMouseDragMode : public Command {
    ...
    void perform(MainWidget* widget) { widget->toggle_mouse_drag_mode(); }

    std::string get_name() { return "toggle_mouse_drag_mode"; }
...
class CloseWindowCommand : public Command {
    ...
    void perform(MainWidget* widget) { widget->close(); }

    std::string get_name() { return "close_window"; }
...
class NewWindowCommand : public Command {
    ...
    void perform(MainWidget* widget) { widget->handle_new_window(); }

    std::string get_name() { return "new_window"; }
...
class EscapeCommand : public Command {
    ...
    void perform(MainWidget* widget) { widget->handle_escape(); }

    std::string get_name() { return "escape"; }
...
class OpenLinkCommand : public Command {
  ...
  public:
    virtual std::string text_requirement_name() { return "Label"; }
    ...
    virtual std::optional<Requirement> next_requirement(MainWidget* widget) {
        if (text.has_value()) {
            ...
            if ((widget->num_visible_links() < 26) && ALPHABETIC_LINK_TAGS) {
                ...
                return Requirement{
                    RequirementType::Text, text_requirement_name()};
            }
        }
    }
    ...
    virtual std::string get_name() { return "open_link"; }
...
class OverviewLinkCommand : public OpenLinkCommand {
    ...
    std::string get_name() { return "overview_link"; }
};
...
class PortalToLinkCommand : public OpenLinkCommand {
    ...
    std::string get_name() { return "portal_to_link"; }
};
...
class CopyLinkCommand : public TextCommand {
    ...
    std::string get_name() { return "copy_link"; }

    std::string text_requirement_name() { return "Label"; }
};
...
class KeyboardSelectCommand : public TextCommand {
    ...
    void pre_perform(MainWidget* widget) { widget->highlight_words(); }

    std::string get_name() { return "keyboard_select"; }

    std::string text_requirement_name() { return "Labels"; }
};
...
class KeyboardOverviewCommand : public TextCommand {
    ...
    std::string get_name() { return "keyboard_overview"; }
...
class KeyboardSmartjumpCommand : public TextCommand {
    ...
    std::string get_name() { return "keyboard_smart_jump"; }
...
class KeysUserCommand : public Command {
    ...
    std::string get_name() { return "keys_user"; }
...
class KeysUserAllCommand : public Command {
    ...
    void perform(MainWidget* widget) { widget->handle_keys_user_all(); }

    std::string get_name() { return "keys_user_all"; }
...
class PrefsUserCommand : public Command {
    ...
    std::string get_name() { return "prefs_user"; }
...
class PrefsUserAllCommand : public Command {
    ...
    void perform(MainWidget* widget) { widget->handle_prefs_user_all(); }

    std::string get_name() { return "prefs_user_all"; }
...
class FitToPageWidthRatioCommand : public Command {
    ...
    std::string get_name() { return "fit_to_page_width_ratio"; }
};
...
class SmartJumpUnderCursorCommand : public Command {
    ...
    std::string get_name() { return "smart_jump_under_cursor"; }
};
...
class OverviewUnderCursorCommand : public Command {
    ...
    std::string get_name() { return "overview_under_cursor"; }
};
...
class SynctexUnderCursorCommand : public Command {
    ...
    std::string get_name() { return "synctex_under_cursor"; }
};
...
class VisualMarkUnderCursorCommand : public Command {
    ...
    std::string get_name() { return "visual_mark_under_cursor"; }
};
...
class CloseOverviewCommand : public Command {
    ...
    std::string get_name() { return "close_overview"; }
};
...
class CloseVisualMarkCommand : public Command {
    ...
    std::string get_name() { return "close_visual_mark"; }
};
...
class ZoomInCursorCommand : public Command {
    ...
    void perform(MainWidget* widget) {
        QPoint mouse_pos = widget->mapFromGlobal(QCursor::pos());
        widget->main_document_view->zoom_in_cursor(
            {mouse_pos.x(), mouse_pos.y()}
        );
        widget->last_smart_fit_page = {};
    }

    std::string get_name() { return "zoom_in_cursor"; }
};
...
class ZoomOutCursorCommand : public Command {
    ...
    std::string get_name() { return "zoom_out_cursor"; }
};
...
class GotoLeftCommand : public Command {
    ...
    std::string get_name() { return "goto_left"; }
};
...
class GotoLeftSmartCommand : public Command {
    ...
    std::string get_name() { return "goto_left_smart"; }
};
...
class GotoRightCommand : public Command {
    ...
    std::string get_name() { return "goto_right"; }
};
...
class GotoRightSmartCommand : public Command {
    ...
    std::string get_name() { return "goto_right_smart"; }
};
...
class RotateClockwiseCommand : public Command {
    ...
    std::string get_name() { return "rotate_clockwise"; }
};
...
class RotateCounterClockwiseCommand : public Command {
    ...
    std::string get_name() { return "rotate_counterclockwise"; }
};
...
class GotoNextHighlightCommand : public Command {
    ...
    std::string get_name() { return "goto_next_highlight"; }
};
...
class GotoPrevHighlightCommand : public Command {
    ...
    std::string get_name() { return "goto_prev_highlight"; }
};
...
class GotoNextHighlightOfTypeCommand : public Command {
    ...
    std::string get_name() { return "goto_next_highlight_of_type"; }
};
...
class GotoPrevHighlightOfTypeCommand : public Command {
    ...
    std::string get_name() { return "goto_prev_highlight_of_type"; }
};

class SetSelectHighlightTypeCommand : public SymbolCommand {
    void perform(MainWidget* widget) { widget->select_highlight_type = symbol; }

    std::string get_name() { return "set_select_highlight_type"; }
...
class AddHighlightWithCurrentTypeCommand : public Command {
    void perform(MainWidget* widget) {
        if (widget->main_document_view->selected_character_rects.size() > 0) {
            widget->main_document_view->add_highlight(
    ...
    std::string get_name() { return "add_highlight_with_current_type"; }
};
...
class EnterPasswordCommand : public TextCommand {
    ...
    std::string get_name() { return "enter_password"; }

    std::string text_requirement_name() { return "Password"; }
};
...
class ToggleFastreadCommand : public Command {
    ...
    std::string get_name() { return "toggle_fastread"; }
};
...
class GotoTopOfPageCommand : public Command {
    ...
    std::string get_name() { return "goto_top_of_page"; }
};
...
class GotoBottomOfPageCommand : public Command {
    ...
    std::string get_name() { return "goto_bottom_of_page"; }
};

class ReloadCommand : public Command {
    void perform(MainWidget* widget) { widget->reload(); }

    std::string get_name() { return "relaod"; }
};
...
class ReloadConfigCommand : public Command {
    ...
    std::string get_name() { return "relaod_config"; }
...
class SetStatusStringCommand : public TextCommand {
    ...
    std::string get_name() { return "set_status_string"; }

    std::string text_requirement_name() { return "Status String"; }

    bool requires_document() { return false; }
};

class ClearStatusStringCommand : public Command {
    void perform(MainWidget* widget) { widget->set_status_message(L""); }

    std::string get_name() { return "clear_status_string"; }

    bool requires_document() { return false; }
};

class ToggleTittlebarCommand : public Command {
    void perform(MainWidget* widget) { widget->toggle_titlebar(); }

    std::string get_name() { return "toggle_titlebar"; }
...
class NextPreviewCommand : public Command {
    ...
    std::string get_name() { return "next_preview"; }
};
...
class PreviousPreviewCommand : public Command {
    ...
    std::string get_name() { return "previous_preview"; }
};

class GotoOverviewCommand : public Command {
    void perform(MainWidget* widget) { widget->goto_overview(); }

    std::string get_name() { return "goto_overview"; }
};

class PortalToOverviewCommand : public Command {
    void perform(MainWidget* widget) { widget->handle_portal_to_overview(); }

    std::string get_name() { return "portal_to_overview"; }
};
...
class GotoSelectedTextCommand : public Command {
    ...
    std::string get_name() { return "goto_selected_text"; }
};
...
class FocusTextCommand : public TextCommand {
    ...
    std::string get_name() { return "focus_text"; }

    std::string text_requirement_name() { return "Text to focus"; }
};

class GotoWindowCommand : public Command {

    void perform(MainWidget* widget) { widget->handle_goto_window(); }

    std::string get_name() { return "goto_window"; }
...
class ToggleSmoothScrollModeCommand : public Command {
    ...
    std::string get_name() { return "toggle_smooth_scroll_mode"; }
...
class ToggleScrollbarCommand : public Command {
    ...
    void perform(MainWidget* widget) { widget->toggle_scrollbar(); }

    std::string get_name() { return "toggle_scrollbar"; }
};

class OverviewToPortalCommand : public Command {

    void perform(MainWidget* widget) { widget->handle_overview_to_portal(); }

    std::string get_name() { return "overview_to_portal"; }
};

class SelectRectCommand : public Command {

    void perform(MainWidget* widget) { widget->set_rect_select_mode(true); }

    std::string get_name() { return "select_rect"; }
};

class ToggleTypingModeCommand : public Command {

    void perform(MainWidget* widget) { widget->handle_toggle_typing_mode(); }

    std::string get_name() { return "toggle_typing_mode"; }
};
...
class OverviewNextItemCommand : public Command {
    ...
    std::string get_name() { return "overview_next_item"; }
};
...
class OverviewPrevItemCommand : public Command {
    ...
    std::string get_name() { return "overview_prev_item"; }
};
...
class DeleteHighlightUnderCursorCommand : public Command {
    ...
    std::string get_name() { return "delete_highlight_under_cursor"; }
};
...
class EnterVisualMarkModeCommand : public Command {
    ...
    void perform(MainWidget* widget) {
        widget->visual_mark_under_pos(
            {widget->width() / 2, widget->height() / 2}
        );
    }

    std::string get_name() { return "enter_visual_mark_mode"; }
};
...
class SetPageOffsetCommand : public TextCommand {
    ...
    std::string get_name() { return "set_page_offset"; }
};

class ToggleVisualScrollCommand : public Command {

    void perform(MainWidget* widget) { widget->toggle_visual_scroll_mode(); }

    std::string get_name() { return "toggle_visual_scroll"; }
};
...
class ToggleHorizontalLockCommand : public Command {
    ...
    std::string get_name() { return "toggle_horizontal_lock"; }
};
...
class EmbedAnnotationsCommand : public Command {
    ...
    std::string get_name() { return "embed_annotations"; }
};
...
class ToggleSelectHighlightCommand : public Command {
    ...
    std::string get_name() { return "toggle_select_highlight"; }
};
...
class OpenLastDocumentCommand : public Command {
    ...
    std::string get_name() { return "open_last_document"; }
...
class ToggleStatusbarCommand : public Command {
    ...
    void perform(MainWidget* widget) { widget->toggle_statusbar(); }

    std::string get_name() { return "toggle_statusbar"; }
            ...
            if (req) {
                ...
                if (req.value().type == RequirementType::Symbol) {
                    if (command_params.size() > 0) {
                        actual_command->set_symbol_requirement((char
                        )command_params[0]);
                    }
                }
            }
...
class CustomCommand : public Command {
  ...
  public:
    ...
    void set_rect_requirement(fz_rect rect) { command_rect = rect; }

    void set_text_requirement(std::wstring txt) { command_text = txt; }
...
class ConfigCommand : public TextCommand {
  ...
  public:
    ConfigCommand(std::string config_name_) { config_name = config_name_; }

    void perform(MainWidget* widget) {
        widget->config_manager->deserialize_config(config_name, text.value());
    }

    std::string get_name() { return "setconfig_" + config_name; }
...
class MacroCommand : public Command {
  ...
  public:
    // MacroCommand(std::string name_, std::vector<std::unique_ptr<NewCommand>>
    // commands_) {
...
CommandManager::CommandManager(ConfigManager* config_manager) {
    ...
    new_commands["goto_beginning"] = []() {
        return std::make_unique<GotoBeginningCommand>();
    };
    new_commands["goto_end"] = []() {
        return std::make_unique<GotoEndCommand>();
    };
    new_commands["goto_definition"] = []() {
        return std::make_unique<GotoDefinitionCommand>();
    };
    new_commands["overview_definition"] = []() {
        return std::make_unique<OverviewDefinitionCommand>();
    };
    new_commands["portal_to_definition"] = []() {
        return std::make_unique<PortalToDefinitionCommand>();
    };
    new_commands["next_item"] = []() {
        return std::make_unique<NextItemCommand>();
    };
    new_commands["previous_item"] = []() {
        return std::make_unique<PrevItemCommand>();
    };
    ...
    new_commands["goto_page_with_page_number"] = []() {
        return std::make_unique<GotoPageWithPageNumberCommand>();
    };
    new_commands["search"] = []() { return std::make_unique<SearchCommand>(); };
    new_commands["regex_search"] = []() {
        return std::make_unique<RegexSearchCommand>();
    };
    new_commands["chapter_search"] = []() {
        return std::make_unique<ChapterSearchCommand>();
    };
    new_commands["move_down"] = []() {
        return std::make_unique<MoveDownCommand>();
    };
    new_commands["move_up"] = []() {
        return std::make_unique<MoveUpCommand>();
    };
    new_commands["move_left"] = []() {
        return std::make_unique<MoveLeftCommand>();
    };
    new_commands["move_right"] = []() {
        return std::make_unique<MoveRightCommand>();
    };
    new_commands["zoom_in"] = []() {
        return std::make_unique<ZoomInCommand>();
    };
    new_commands["zoom_out"] = []() {
        return std::make_unique<ZoomOutCommand>();
    };
    new_commands["fit_to_page_width"] = []() {
        return std::make_unique<FitToPageWidthCommand>();
    };
    new_commands["fit_to_page_height"] = []() {
        return std::make_unique<FitToPageHeightCommand>();
    };
    new_commands["fit_to_page_height_smart"] = []() {
        return std::make_unique<FitToPageHeightSmartCommand>();
    };
    new_commands["fit_to_page_width_smart"] = []() {
        return std::make_unique<FitToPageWidthSmartCommand>();
    };
    new_commands["next_page"] = []() {
        return std::make_unique<NextPageCommand>();
    };
    new_commands["previous_page"] = []() {
        return std::make_unique<PreviousPageCommand>();
    };
    new_commands["open_document"] = []() {
        return std::make_unique<OpenDocumentCommand>();
    };
    new_commands["add_bookmark"] = []() {
        return std::make_unique<AddBookmarkCommand>();
    };
    new_commands["add_highlight"] = []() {
        return std::make_unique<AddHighlightCommand>();
    };
    new_commands["goto_toc"] = []() {
        return std::make_unique<GotoTableOfContentsCommand>();
    };
    new_commands["goto_highlight"] = []() {
        return std::make_unique<GotoHighlightCommand>();
    };
    new_commands["goto_bookmark"] = []() {
        return std::make_unique<GotoBookmarkCommand>();
    };
    new_commands["goto_bookmark_g"] = []() {
        return std::make_unique<GotoBookmarkGlobalCommand>();
    };
    new_commands["goto_highlight_g"] = []() {
        return std::make_unique<GotoHighlightGlobalCommand>();
    };
    new_commands["link"] = []() { return std::make_unique<PortalCommand>(); };
    new_commands["portal"] = []() { return std::make_unique<PortalCommand>(); };
    new_commands["next_state"] = []() {
        return std::make_unique<NextStateCommand>();
    };
    new_commands["prev_state"] = []() {
        return std::make_unique<PrevStateCommand>();
    };
    new_commands["delete_link"] = []() {
        return std::make_unique<DeletePortalCommand>();
    };
    new_commands["delete_portal"] = []() {
        return std::make_unique<DeletePortalCommand>();
    };
    new_commands["delete_bookmark"] = []() {
        return std::make_unique<DeleteBookmarkCommand>();
    };
    new_commands["delete_highlight"] = []() {
        return std::make_unique<DeleteHighlightCommand>();
    };
    new_commands["goto_link"] = []() {
        return std::make_unique<GotoPortalCommand>();
    };
    new_commands["goto_portal"] = []() {
        return std::make_unique<GotoPortalCommand>();
    };
    new_commands["edit_link"] = []() {
        return std::make_unique<EditPortalCommand>();
    };
    new_commands["edit_portal"] = []() {
        return std::make_unique<EditPortalCommand>();
    };
    new_commands["open_prev_doc"] = []() {
        return std::make_unique<OpenPrevDocCommand>();
    };
    new_commands["open_document_embedded"] = []() {
        return std::make_unique<OpenDocumentEmbeddedCommand>();
    };
    new_commands["open_document_embedded_from_current_path"] = []() {
        return std::make_unique<OpenDocumentEmbeddedFromCurrentPathCommand>();
    };
    ...
    new_commands["toggle_one_window"] = []() {
        return std::make_unique<ToggleOneWindowCommand>();
    };
    new_commands["toggle_highlight"] = []() {
        return std::make_unique<ToggleHighlightCommand>();
    };
    new_commands["toggle_synctex"] = []() {
        return std::make_unique<ToggleSynctexCommand>();
    };
    new_commands["turn_on_synctex"] = []() {
        return std::make_unique<TurnOnSynctexCommand>();
    };
    new_commands["toggle_show_last_command"] = []() {
        return std::make_unique<ToggleShowLastCommand>();
    };
    new_commands["command"] = []() {
        return std::make_unique<CommandCommand>();
    };
    new_commands["external_search"] = []() {
        return std::make_unique<ExternalSearchCommand>();
    };
    new_commands["open_selected_url"] = []() {
        return std::make_unique<OpenSelectedUrlCommand>();
    };
    new_commands["screen_down"] = []() {
        return std::make_unique<ScreenDownCommand>();
    };
    new_commands["screen_up"] = []() {
        return std::make_unique<ScreenUpCommand>();
    };
    new_commands["next_chapter"] = []() {
        return std::make_unique<NextChapterCommand>();
    };
    new_commands["prev_chapter"] = []() {
        return std::make_unique<PrevChapterCommand>();
    };
    new_commands["toggle_dark_mode"] = []() {
        return std::make_unique<ToggleDarkModeCommand>();
    };
    new_commands["toggle_presentation_mode"] = []() {
        return std::make_unique<TogglePresentationModeCommand>();
    };
    new_commands["turn_on_presentation_mode"] = []() {
        return std::make_unique<TurnOnPresentationModeCommand>();
    };
    new_commands["toggle_mouse_drag_mode"] = []() {
        return std::make_unique<ToggleMouseDragMode>();
    };
    new_commands["close_window"] = []() {
        return std::make_unique<CloseWindowCommand>();
    };
    ...
    new_commands["open_link"] = []() {
        return std::make_unique<OpenLinkCommand>();
    };
    new_commands["overview_link"] = []() {
        return std::make_unique<OverviewLinkCommand>();
    };
    new_commands["portal_to_link"] = []() {
        return std::make_unique<PortalToLinkCommand>();
    };
    new_commands["copy_link"] = []() {
        return std::make_unique<CopyLinkCommand>();
    };
    new_commands["keyboard_select"] = []() {
        return std::make_unique<KeyboardSelectCommand>();
    };
    new_commands["keyboard_smart_jump"] = []() {
        return std::make_unique<KeyboardSmartjumpCommand>();
    };
    new_commands["keyboard_overview"] = []() {
        return std::make_unique<KeyboardOverviewCommand>();
    };
    new_commands["keys"] = []() { return std::make_unique<KeysCommand>(); };
    new_commands["keys_user"] = []() {
        return std::make_unique<KeysUserCommand>();
    };
    new_commands["prefs"] = []() { return std::make_unique<PrefsCommand>(); };
    new_commands["prefs_user"] = []() {
        return std::make_unique<PrefsUserCommand>();
    };
    new_commands["move_visual_mark_down"] = []() {
        return std::make_unique<MoveVisualMarkDownCommand>();
    };
    new_commands["move_visual_mark_up"] = []() {
        return std::make_unique<MoveVisualMarkUpCommand>();
    };
    new_commands["toggle_custom_color"] = []() {
        return std::make_unique<ToggleCustomColorMode>();
    };
    new_commands["set_select_highlight_type"] = []() {
        return std::make_unique<SetSelectHighlightTypeCommand>();
    };
    new_commands["toggle_window_configuration"] = []() {
        return std::make_unique<ToggleWindowConfigurationCommand>();
    };
    new_commands["prefs_user_all"] = []() {
        return std::make_unique<PrefsUserAllCommand>();
    };
    new_commands["keys_user_all"] = []() {
        return std::make_unique<KeysUserAllCommand>();
    };
    new_commands["fit_to_page_width_ratio"] = []() {
        return std::make_unique<FitToPageWidthRatioCommand>();
    };
    new_commands["smart_jump_under_cursor"] = []() {
        return std::make_unique<SmartJumpUnderCursorCommand>();
    };
    new_commands["overview_under_cursor"] = []() {
        return std::make_unique<OverviewUnderCursorCommand>();
    };
    new_commands["close_overview"] = []() {
        return std::make_unique<CloseOverviewCommand>();
    };
    new_commands["visual_mark_under_cursor"] = []() {
        return std::make_unique<VisualMarkUnderCursorCommand>();
    };
    new_commands["close_visual_mark"] = []() {
        return std::make_unique<CloseVisualMarkCommand>();
    };
    new_commands["zoom_in_cursor"] = []() {
        return std::make_unique<ZoomInCursorCommand>();
    };
    new_commands["zoom_out_cursor"] = []() {
        return std::make_unique<ZoomOutCursorCommand>();
    };
    new_commands["goto_left"] = []() {
        return std::make_unique<GotoLeftCommand>();
    };
    new_commands["goto_left_smart"] = []() {
        return std::make_unique<GotoLeftSmartCommand>();
    };
    new_commands["goto_right"] = []() {
        return std::make_unique<GotoRightCommand>();
    };
    new_commands["goto_right_smart"] = []() {
        return std::make_unique<GotoRightSmartCommand>();
    };
    new_commands["rotate_clockwise"] = []() {
        return std::make_unique<RotateClockwiseCommand>();
    };
    new_commands["rotate_counterclockwise"] = []() {
        return std::make_unique<RotateCounterClockwiseCommand>();
    };
    new_commands["goto_next_highlight"] = []() {
        return std::make_unique<GotoNextHighlightCommand>();
    };
    new_commands["goto_prev_highlight"] = []() {
        return std::make_unique<GotoPrevHighlightCommand>();
    };
    new_commands["goto_next_highlight_of_type"] = []() {
        return std::make_unique<GotoNextHighlightOfTypeCommand>();
    };
    new_commands["goto_prev_highlight_of_type"] = []() {
        return std::make_unique<GotoPrevHighlightOfTypeCommand>();
    };
    new_commands["add_highlight_with_current_type"] = []() {
        return std::make_unique<AddHighlightWithCurrentTypeCommand>();
    };
    new_commands["enter_password"] = []() {
        return std::make_unique<EnterPasswordCommand>();
    };
    new_commands["toggle_fastread"] = []() {
        return std::make_unique<ToggleFastreadCommand>();
    };
    new_commands["goto_top_of_page"] = []() {
        return std::make_unique<GotoTopOfPageCommand>();
    };
    new_commands["goto_bottom_of_page"] = []() {
        return std::make_unique<GotoBottomOfPageCommand>();
    };
    new_commands["new_window"] = []() {
        return std::make_unique<NewWindowCommand>();
    };
    new_commands["reload"] = []() { return std::make_unique<ReloadCommand>(); };
    new_commands["reload_config"] = []() {
        return std::make_unique<ReloadConfigCommand>();
    };
    new_commands["synctex_under_cursor"] = []() {
        return std::make_unique<SynctexUnderCursorCommand>();
    };
    new_commands["set_status_string"] = []() {
        return std::make_unique<SetStatusStringCommand>();
    };
    new_commands["clear_status_string"] = []() {
        return std::make_unique<ClearStatusStringCommand>();
    };
    new_commands["toggle_titlebar"] = []() {
        return std::make_unique<ToggleTittlebarCommand>();
    };
    new_commands["next_preview"] = []() {
        return std::make_unique<NextPreviewCommand>();
    };
    new_commands["previous_preview"] = []() {
        return std::make_unique<PreviousPreviewCommand>();
    };
    new_commands["goto_overview"] = []() {
        return std::make_unique<GotoOverviewCommand>();
    };
    new_commands["portal_to_overview"] = []() {
        return std::make_unique<PortalToOverviewCommand>();
    };
    new_commands["goto_selected_text"] = []() {
        return std::make_unique<GotoSelectedTextCommand>();
    };
    new_commands["focus_text"] = []() {
        return std::make_unique<FocusTextCommand>();
    };
    new_commands["goto_window"] = []() {
        return std::make_unique<GotoWindowCommand>();
    };
    new_commands["toggle_smooth_scroll_mode"] = []() {
        return std::make_unique<ToggleSmoothScrollModeCommand>();
    };
    new_commands["goto_begining"] = []() {
        return std::make_unique<GotoBeginningCommand>();
    };
    new_commands["toggle_scrollbar"] = []() {
        return std::make_unique<ToggleScrollbarCommand>();
    };
    new_commands["overview_to_portal"] = []() {
        return std::make_unique<OverviewToPortalCommand>();
    };
    new_commands["select_rect"] = []() {
        return std::make_unique<SelectRectCommand>();
    };
    new_commands["toggle_typing_mode"] = []() {
        return std::make_unique<ToggleTypingModeCommand>();
    };
    new_commands["donate"] = []() { return std::make_unique<DonateCommand>(); };
    new_commands["overview_next_item"] = []() {
        return std::make_unique<OverviewNextItemCommand>();
    };
    new_commands["overview_prev_item"] = []() {
        return std::make_unique<OverviewPrevItemCommand>();
    };
    new_commands["delete_highlight_under_cursor"] = []() {
        return std::make_unique<DeleteHighlightUnderCursorCommand>();
    };
    ...
    new_commands["enter_visual_mark_mode"] = []() {
        return std::make_unique<EnterVisualMarkModeCommand>();
    };
    new_commands["set_page_offset"] = []() {
        return std::make_unique<SetPageOffsetCommand>();
    };
    new_commands["toggle_visual_scroll"] = []() {
        return std::make_unique<ToggleVisualScrollCommand>();
    };
    new_commands["toggle_horizontal_scroll_lock"] = []() {
        return std::make_unique<ToggleHorizontalLockCommand>();
    };
    new_commands["execute"] = []() {
        return std::make_unique<ExecuteCommand>();
    };
    new_commands["embed_annotations"] = []() {
        return std::make_unique<EmbedAnnotationsCommand>();
    };
    new_commands["copy_window_size_config"] = []() {
        return std::make_unique<CopyWindowSizeConfigCommand>();
    };
    new_commands["toggle_select_highlight"] = []() {
        return std::make_unique<ToggleSelectHighlightCommand>();
    };
    new_commands["open_last_document"] = []() {
        return std::make_unique<OpenLastDocumentCommand>();
    };
    new_commands["toggle_statusbar"] = []() {
        return std::make_unique<ToggleStatusbarCommand>();
    };
    ...
    for (auto conf : configs) {
        ...
        // commands.push_back({ config_set_command_name, true, false , false,
        // false, true, {} });
...
bool Command::requires_document() { return true; }

void Command::set_num_repeats(int nr) { num_repeats = nr; }
...
std::string Command::get_name() { return ""; }
